...
typedef CGFloat (^MLTableAlertTableCellsHeightBlock)(MLTableAlert *alert, NSIndexPath *indexPath);
typedef void (^MLTableAlertRowSelectionBlock)(NSIndexPath *selectedIndex);
typedef void (^MLTableAlertCompletionBlock)(void);
typedef void (^MLTableAlertOkButtonOnClick)(void);
typedef void (^MLTableAlertCancelButtonOnClick)(void);
typedef void (^MLTableAlertOtherButtonOnClick)(void);
...
@property (nonatomic, strong) MLTableAlertOkButtonOnClick okButtonOnClick;
@property (nonatomic, strong) MLTableAlertOkButtonOnClick cancelButtonOnClick;
@property (nonatomic, strong) MLTableAlertOkButtonOnClick otherButtonOnClick;
