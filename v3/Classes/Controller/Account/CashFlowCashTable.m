...
@interface CashFlowCashTable() <UITableViewDataSource>
...
@implementation CashFlowCashTable
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Float64 test = 500151300.900000 ;
    
    NSLog(@"Test = %f",test);
    
    UILabel *left = [cell.contentView viewWithTag:1];
    NSLog(@"Cash Balance Nyoman = %f",self.cash.t0);
    if(self.cash) {
